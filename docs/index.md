...
cd QuantiSNP/MCR
wget ftp://ftp.stats.ox.ac.uk/pub/yau/quantisnp2/mcr/MCRinstaller64.run && chmod u+rx MCRinstaller64.run
...
Here is my output for the MCR v7.9 setup.
```text
(base) nomade@nomade-Aspire-V3-571:~/QuantiSNP/MCR$ wget ftp://ftp.stats.ox.ac.uk/pub/yau/quantisnp2/mcr/MCRinstaller64.run
--2019-10-19 14:57:34--  ftp://ftp.stats.ox.ac.uk/pub/yau/quantisnp2/mcr/MCRinstaller64.run
           => ‘MCRinstaller64.run’
...
==> SYST ... done.    ==> PWD ... done.
==> TYPE I ... done.  ==> CWD (1) /pub/yau/quantisnp2/mcr ... done.
...
```bash
cd ..
wget ftp://ftp.stats.ox.ac.uk/pub/yau/quantisnp2/executables/09042010/install_quantisnp && chmod u+rx install_quantisnp
...
```bash
quantiSNP=./QuantiSNP/quantisnp/linux64/run_quantisnp2.sh
...
```text
My Own Exception: Fatal error loading library /home/nomade/Downloads/QUANTISNP2/v79/bin/glnxa64/libmwmclmcr.so Error: libXp.so.6: cannot open shared object file: No such file or directory
```
...
```text
	...
	libmwmcr.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwmcr.so (0x00007f7ef5d5f000)
	libut.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libut.so (0x00007f7ef587c000)
	libmwfl.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwfl.so (0x00007f7ef5752000)
	libmx.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmx.so (0x00007f7ef55e3000)
	libmwservices.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwservices.so (0x00007f7ef536b000)
	libmex.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmex.so (0x00007f7ef525a000)
	libmwctfarchiver.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwctfarchiver.so (0x00007f7ef513c000)
	libmwctfrt.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwctfrt.so (0x00007f7ef5031000)
	libmwctfrtcrypto.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwctfrtcrypto.so (0x00007f7ef4e41000)
	libmwm_interpreter.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwm_interpreter.so (0x00007f7ef4716000)
	libmwm_dispatcher.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwm_dispatcher.so (0x00007f7ef45b2000)
	libmwmpath.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwmpath.so (0x00007f7ef447a000)
	libmwjmi.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwjmi.so (0x00007f7ef4326000)
	libmwdservices.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwdservices.so (0x00007f7ef41f5000)
	libmwudd.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libmwudd.so (0x00007f7ef400f000)
	libboost_regex-gcc41-mt-1_34_1.so.1.34.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libboost_regex-gcc41-mt-1_34_1.so.1.34.1 (0x00007f7ef3e7f000)
	libz.so.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/libz.so.1 (0x00007f7ef3d69000)
	libstdc++.so.6 => ./QUANTISNP2/v79/bin/glnxa64/../../sys/os/glnxa64/libstdc++.so.6 (0x00007f7ef3b6b000)
	libm.so.6 => /lib/x86_64-linux-gnu/libm.so.6 (0x00007f7ef37cd000)
	libgcc_s.so.1 => ./QUANTISNP2/v79/bin/glnxa64/../../sys/os/glnxa64/libgcc_s.so.1 (0x00007f7ef36c0000)
	...
	libmwiqm.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwiqm.so (0x00007f7ef2f85000)
	libmwbridge.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwbridge.so (0x00007f7ef2e5b000)
	libmat.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmat.so (0x00007f7ef2d38000)
	libmwmlutil.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmlutil.so (0x00007f7ef2c12000)
	libmwm_parser.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwm_parser.so (0x00007f7ef2498000)
	libmwmlint.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmlint.so (0x00007f7ef2334000)
	libmwmtok.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmtok.so (0x00007f7ef222d000)
	libmwmcos.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmcos.so (0x00007f7ef1f13000)
	libmwgui.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwgui.so (0x00007f7ef1cd4000)
	libmwhg.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwhg.so (0x00007f7ef1941000)
	libuij.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libuij.so (0x00007f7ef1804000)
	libmwudd_mi.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwudd_mi.so (0x00007f7ef1675000)
	libmwuinone.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwuinone.so (0x00007f7ef156f000)
	libmwm_ir.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwm_ir.so (0x00007f7ef1423000)
	libmwmathutil.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmathutil.so (0x00007f7ef12ba000)
	libmwuix.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwuix.so (0x00007f7ef1047000)
	...
	libexpat.so.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libexpat.so.1 (0x00007f7ef0b18000)
	libicudata.so.36 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libicudata.so.36 (0x00007f7ef0a17000)
	libicuuc.so.36 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libicuuc.so.36 (0x00007f7ef07e0000)
	libicui18n.so.36 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libicui18n.so.36 (0x00007f7ef059e000)
	libicuio.so.36 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libicuio.so.36 (0x00007f7ef0492000)
	libboost_thread-gcc41-mt-1_34_1.so.1.34.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libboost_thread-gcc41-mt-1_34_1.so.1.34.1 (0x00007f7ef0386000)
	libboost_signals-gcc41-mt-1_34_1.so.1.34.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libboost_signals-gcc41-mt-1_34_1.so.1.34.1 (0x00007f7ef0275000)
	libncurses.so.5 => /lib/x86_64-linux-gnu/libncurses.so.5 (0x00007f7ef0052000)
	libmwprofiler.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwprofiler.so (0x00007f7eeff19000)
	libmwmathrng.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmathrng.so (0x00007f7eefdf4000)
	libmwmlib.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmlib.so (0x00007f7eefce8000)
	libmwm_pcodeio.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwm_pcodeio.so (0x00007f7eefbd5000)
	libmwm_pcodegen.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwm_pcodegen.so (0x00007f7eefabc000)
	libxerces-c.so.27 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libxerces-c.so.27 (0x00007f7eef5b4000)
	libmwdatasvcs.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwdatasvcs.so (0x00007f7eef49a000)
	libboost_filesystem-gcc41-mt-1_34_1.so.1.34.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libboost_filesystem-gcc41-mt-1_34_1.so.1.34.1 (0x00007f7eef38d000)
	/lib64/ld-linux-x86-64.so.2 (0x00007f7ef5ea0000)
	libhdf5.so.0 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libhdf5.so.0 (0x00007f7eef170000)
	libmwir_xfmr.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwir_xfmr.so (0x00007f7eef062000)
	libmwhardcopy.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwhardcopy.so (0x00007f7eeef32000)
	libmwmathlinalg.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmathlinalg.so (0x00007f7eeed5f000)
	libXm.so.3 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../sys/os/glnxa64/libXm.so.3 (0x00007f7eee9c4000)
	...
	libmwxmlcore.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwxmlcore.so (0x00007f7eedc59000)
	libmwmathelem.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmathelem.so (0x00007f7eeda3e000)
	libmwmathcore.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwmathcore.so (0x00007f7eed8f4000)
	libmwblas.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwblas.so (0x00007f7eed7de000)
	libmwlapack.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwlapack.so (0x00007f7eed61d000)
	libmwamd.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwamd.so (0x00007f7eed515000)
	libmwcholmod.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwcholmod.so (0x00007f7eed3a1000)
	libmwcolamd.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwcolamd.so (0x00007f7eed29b000)
	libmwcsparse.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwcsparse.so (0x00007f7eed190000)
	libmwma57.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwma57.so (0x00007f7eed06a000)
	libmwrookfastbp.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwrookfastbp.so (0x00007f7eecf3a000)
	libmwumfpack.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwumfpack.so (0x00007f7eecd96000)
	...
	libmwbinder.so => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libmwbinder.so (0x00007f7eec220000)
	libgfortran.so.1 => ./QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../sys/os/glnxa64/libgfortran.so.1 (0x00007f7eec08c000)
...
cp -rf ./QUANTISNP/lib/* ./QUANTISNP2/v79/bin/glnxa64
# then execute
...
```text
	...
	libXp.so.6 => /home/nomade/Downloads/QUANTISNP2/v79/bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/../../bin/glnxa64/libXp.so.6 (0x00007ff403e96000)
```
